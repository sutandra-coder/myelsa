...
logindb_controller = Blueprint('logindb_controller_api', __name__)
api = Api(logindb_controller,  title='MyElsa API',description='MyElsa API')
name_space = api.namespace('logindbController',description='Logindb Controller')
